...
public class StringUtils {
    ...
    public static String def(Object val, String def) {
    ...
    public static String format(String str, Object... params) {
        ...
        while (true) {
            ...
            if (pos >= 0) {
                sb.append(str, offset, pos);
                if (params.length > step) {
                    sb.append(params[step]);
                }
                step++;
                offset = pos + 2;
            } else {
    ...
    public static boolean nonBlank(String... strs) {
        for (String str : strs) {
            if (isBlank(str)) {
                return false;
            }
    ...
    public static String join(String joiner, Object... params) {
        Assert.notNull(joiner, "joiner");
        Assert.state(params.length > 0, "params.length should be bigger than 0!");
    ...
    public static String join(String joiner, Iterable<Object> list) {
        return join(joiner, list, false);
    }

    public static String join(String joiner, Iterable<Object> list, boolean ignoreNullOrEmpty) {
        Assert.notNull(joiner, "joiner");
    ...
    public static List<String> split(String str, String delim) {
        Assert.notNull(str, "param str cannot be null!");
        StringTokenizer st =
                delim == null ?
    ...
    public static Properties splitArrayElementsIntoProperties(
        ...
        for (String element : array) {
            ...
            List<String> splittedElement = split(element, delimiter);
            if (splittedElement == null) {
                continue;
            }
            result.setProperty(splittedElement.get(0).trim(), splittedElement.get(1).trim());
        }
        return result;
    }
